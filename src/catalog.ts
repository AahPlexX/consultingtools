...
const reasoning = (
  ...
  domain: CapabilityDomain,
  summary: string,
): Capability => ({ id, name, domain, mode: "reasoning", status: "implemented", summary });
...
export const capabilities: readonly Capability[] = [
  ...
  },
  {
    ...
    summary: "Use verified query, demand, difficulty, or performance metrics when an authorized data source provides them.",
    requires: "Authorized first-party or commercial keyword/search data provider.",
  },
  {
    ...
    mode: "external",
    status: "provider-dependent",
    summary: "Analyze link evidence and provider-defined authority metrics without presenting proprietary estimates as universal facts.",
    requires: "Authorized backlink data provider.",
  },
  {
    ...
    mode: "external",
    status: "provider-dependent",
    summary: "Analyze impressions, clicks, position, indexing, and query/page performance from an authorized search-console source.",
    requires: "Authorized search-console connection.",
  },
